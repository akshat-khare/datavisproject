...
sys.path.insert(0, os.path.abspath('../../Dashboard_Website/myapp/mongo'))
...
copyright = '2018, Deepak Saini, Abhishek Gupta'
...
htmlhelp_basename = 'TwitterAnalyticsDocumentationdoc'
...
latex_documents = [
    (master_doc, 'TwitterAnalyticsDocumentation.tex', 'Twitter Analytics Documentation',
     'Deepak Saini, Abhishek Gupta', 'manual'),
]
...
man_pages = [
    (master_doc, 'twitteranalyticsdocumentation', 'Twitter Analytics',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TwitterAnalyticsDocumentation', 'Twitter Analytics Documentation',
     author, 'TwitterAnalyticsDocumentation', 'One line description of project.',
     'Miscellaneous'),
]
